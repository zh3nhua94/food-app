...
// below here basically is how it is exported, 'featuredProducts' is the name,
// Products is the schema which is reusable for other exports names, like below another export 'Pizzas'

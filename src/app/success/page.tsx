...
const SuccessPage = () => {
	const searchParams = useSearchParams(); //hook to search parameters in url
	...
	return (
		<div className="text-center">
			<div
				role="status"
				className="p-4 min-h-[calc(100vh-6rem)] md:min-h-[calc(100vh-15rem)] flex justify-center items-center flex-col"
			>
